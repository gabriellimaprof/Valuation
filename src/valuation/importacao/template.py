...
def _aba_instrucoes(ws) -> None:
    ...
    linhas = [
        ...
        ("4. Custos, despesas e capex podem ser positivos ou negativos:", False),
        ("   o app usa a magnitude e padroniza o sinal sozinho.", False),
        ("4a. EXCECAO: 'IR e CSLL correntes' e 'IR e CSLL diferidos' precisam do", False),
        ("    SINAL: despesa negativa, credito positivo. Credito nao e caso raro --", False),
        ("    221 das 467 companhias da CVM tiveram credito no diferido em 2024, e em", False),
        ("    204 delas corrente e diferido tem sinais opostos. Somar magnitudes", False),
        ("    transformaria credito em despesa e a DRE nao fecharia.", False),
        ("    Se voce preencher os dois e o LAIR e o lucro liquido, o app confere e", False),
        ("    corrige o sinal quando consegue; quando nao consegue, avisa.", False),
